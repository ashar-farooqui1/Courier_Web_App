...
import { ChevronDown, Trash2, FileBox } from 'lucide-react';
  ...
  return (
    <div className="space-y-6 max-w-[1600px] mx-auto animate-in fade-in duration-500">
      ...
      <div className="bg-white p-8 rounded-xl border border-slate-100 shadow-sm flex flex-wrap items-center gap-6">
        ...
        <div className="flex-1 min-w-[150px] space-y-1.5 pt-5">
           <Button className="w-full bg-primary hover:bg-primary/90 text-white font-bold text-xs uppercase tracking-widest h-10 gap-2">
        ...
        <div className="flex-[2] min-w-[300px] space-y-1.5">
          ...
          <input type="date" className="w-full h-10 px-4 bg-white border border-slate-200 rounded-md text-xs font-bold text-primary focus:outline-none" />
        </div>

        <div className="flex-1 min-w-[150px] space-y-1.5 pt-5">
           <Button className="w-full bg-primary hover:bg-primary/90 text-white font-bold text-xs uppercase tracking-widest h-10 gap-2 shadow-lg shadow-primary/20">
             <FileBox size={14} /> Create RollCart
           </Button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 overflow-hidden">
        <div className="p-6 border-b border-slate-50 flex items-center justify-between bg-slate-50/30">
          <h4 className="text-[11px] font-bold text-slate-400 uppercase tracking-widest">Total 0 Scaned Succesfully!</h4>
        </div>
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left">
            ...
            <tbody>
              <tr>
                <td colSpan={10} className="py-20 text-center text-slate-200 italic text-sm font-medium uppercase tracking-widest">
