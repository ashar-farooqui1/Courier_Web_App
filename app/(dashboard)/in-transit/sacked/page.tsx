...
export default function SackedPage() {
  const tabs = [
  ...
  const tableHeaders = [
    'AWB ID', 'Ref ID', 'Client Name', 'Customer Name', 'Origin City', 
    'Destination City', 'Amount', 'Pickup Date', 'Booking Date', 
    'Status', 'WareHouse'
  ];
      ...
      <div className="bg-white rounded-xl shadow-sm border border-slate-100 p-6">
        <div className="flex flex-wrap items-center gap-6">
          ...
          <div className="flex items-center gap-2 px-4">
            ...
            />
            <label htmlFor="misroute" className="text-[11px] font-bold text-slate-500 uppercase cursor-pointer select-none">
              Any Misroute Parcels
            </label>
          </div>
