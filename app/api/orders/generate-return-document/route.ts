...
import { generateReturnDocument } from "@/lib/api/order";
...
/** Proxies POST /api/Order/GenerateReturnDocument */
export async function POST(request: Request) {
  ...
  try {
    const { blob, filename } = await generateReturnDocument(payload, token);
