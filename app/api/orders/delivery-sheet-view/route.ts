...
import { getDeliverySheetView } from '@/lib/api/order';
...
/** Proxies GET /api/Order/GetDeliverySheetView?deliverySheetId= */
export async function GET(request: Request) {
  ...
  try {
    const data = await getDeliverySheetView(deliverySheetId, token);
