...
import { closeDeliverySheet } from "@/lib/api/order";
...
/** Proxies POST /api/Order/CloseDeliverySheet */
export async function POST(request: Request) {
  ...
  try {
    const message = await closeDeliverySheet(deliverySheetId, token);
    ...
    const message = error instanceof Error ? error.message : "Failed to close delivery sheet";
