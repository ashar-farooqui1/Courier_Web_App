...
import { ArrowLeft, Package, User, MapPin, Clock, AlertCircle, MessageSquare, Send } from "lucide-react";
...
export function OrderDetailView({ orderId, backHref, token, role, userId, roleId }: OrderDetailViewProps) {
  ...
  return (
    <div className="p-6 space-y-4">
      ...
      <div className="bg-primary px-6 py-4 rounded-xl flex items-center gap-3 text-white shadow-sm">
